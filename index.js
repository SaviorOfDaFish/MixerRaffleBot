...
// The starter database already has a `guesses` table, but it does not have
// the raffle_id and is_correct columns used by v1.1. Add those columns before
// creating indexes that reference them.
